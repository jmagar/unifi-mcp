...
class TestReconnectClientTool:
    ...
    async def test_reconnect_client_normalization(self, client_tools_server):
        ...
        mac_formats = ["AA:BB:CC:DD:EE:F1", "AA-BB-CC-DD-EE-F1", "aa.bb.cc.dd.ee.f1", "  aa:bb:cc:dd:ee:f1  "]
...
class TestSetClientNameTool:
    ...
    async def test_set_client_name_success(self, client_tools_server):
        ...
        async with Client(client_tools_server) as client:
            result = await client.call_tool("set_client_name", {"mac": client_mac, "name": new_name})
    ...
    async def test_set_client_name_not_found(self, client_tools_server):
        ...
        async with Client(client_tools_server) as client:
            result = await client.call_tool("set_client_name", {"mac": nonexistent_mac, "name": "Test Name"})
    ...
    async def test_set_client_name_empty_name(self, client_tools_server):
        ...
        async with Client(client_tools_server) as client:
            result = await client.call_tool("set_client_name", {"mac": client_mac, "name": ""})
...
class TestSetClientNoteTool:
    ...
    async def test_set_client_note_success(self, client_tools_server):
        ...
        async with Client(client_tools_server) as client:
            result = await client.call_tool("set_client_note", {"mac": client_mac, "note": note})
    ...
    async def test_set_client_note_not_found(self, client_tools_server):
        ...
        async with Client(client_tools_server) as client:
            result = await client.call_tool("set_client_note", {"mac": nonexistent_mac, "note": "Test note"})
    ...
    async def test_real_client_lookup(self, integration_config):
        ...
        try:
            async with Client(mcp) as test_client, client:
                ...
                if isinstance(clients_result.structured_content, list) and len(clients_result.structured_content) > 0:
